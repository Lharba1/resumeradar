...
export function TrialStarted({ userName, trialEndDate }: TrialStartedProps) {
  return (
    <Html lang="en">
      <Head />
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={heading}>Your 3-day Pro trial has started</Text>
            <Text style={paragraph}>Hi {userName},</Text>
            <Text style={paragraph}>
              Your Pro trial is now active. Here's what you get:
            </Text>
            ...
            <Text style={paragraph}>
              Your trial ends on <strong>{trialEndDate}</strong>. No charge until then —
