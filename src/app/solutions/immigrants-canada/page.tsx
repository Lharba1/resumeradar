      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-12 rounded-2xl border border-[#dcdce3] bg-white p-6">
          ...
          <p className="leading-relaxed text-[#3B4959]">
            According to <a href="https://www150.statcan.gc.ca/n1/pub/71-606-x/2008001/t/4123084-eng.htm" target="_blank" rel="noopener noreferrer" className="text-[#006EDC] underline">Statistics Canada</a>, immigrants with foreign credentials are 3× more likely to be overqualified for their first Canadian job than Canadian-born workers. A significant part of this gap is not qualification-related — it is resume formatting. Over 95% of Canadian employers with 50+ employees use Applicant Tracking Systems (ATS)<sup><a href="https://business.linkedin.com/talent-solutions/blog/trends-and-research/2018/5-recruiter-efficiency-stats-that-will-make-you-think-twice-about-ats" target="_blank" rel="noopener noreferrer" className="text-[#006EDC]">[1]</a></sup> that automatically screen resumes before any human reads them. Resumes not formatted to Canadian standards, missing Canadian job title conventions, or lacking the exact keywords from the posting are eliminated silently. Immigrants face an additional barrier: their education and experience are described in terminology that Canadian ATS systems do not recognize. ResumeRadar's AI understands both sides — it maps international credentials and experience into Canadian job market language, rebuilds bullets to pass ATS filters, and outputs professionally formatted English or French CVs.
          </p>
        </div>
